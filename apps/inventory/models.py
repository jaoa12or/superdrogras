...
class Inventory(BaseModel):
    ...
    last_entry_date = models.DateField(default=now,blank=False,null=True,verbose_name='Fecha Ultima Entrada')
    last_output_date = models.DateField(default=now,blank=True,null=True,verbose_name='Fecha Ultima Salida')
